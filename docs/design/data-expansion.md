...
| `mkt_idx_bmk` | 官方基金业绩基准目录 | ✅ **2026-08-03 接入**；保存指数类别与编制机构，市场页不再按名称猜宽基/风格/主题分类 |
| `sw_daily` | 申万行业指数行情与估值 | ✅ **2026-08-03 接入**；仅保存SW2021一级行业31个代码，提供官方PE/PB、总市值和流通市值，禁止混入申万宽基和二三级行业 |
