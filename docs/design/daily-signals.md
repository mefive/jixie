...
> 对应原 `ROADMAP.md` 主线五，当前归入已完成基础 E。
> **2026-08-12 优先级更新**：现有信号与账户能力保留，项目当前先学习理论和建设研究工具；自动券商、
> 多账户和进一步实盘化不在当前 ROADMAP，重新启动需满足其中“长期阶段：模拟与实盘验证”的门槛。

## 目标与边界

系统架构未来可以重新评估自动化下单，但当前只做「收盘后自动生成次日开盘 / 条件触发指令、展示并发送邮件，
用户手工执行或在券商端挂条件单」。
