...
| 毛利率稳定性(504日) | PIT 毛利率阶梯序列总体标准差，至少 4 段报告 | 负(越稳定越好) | fina_indicator ✓ | **探索通过，待一次性 holdout(2026-07-31)** | 冻结哈希 `cbfbef383db09`；探索原始 IC −0.0349 / ICIR −1.93，中性化 IC −0.0213 / ICIR −1.61，均通过预注册 `< -0.01`；未揭示保留段，暂不升预置 |
