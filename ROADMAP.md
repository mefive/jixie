...
`stk_limit` 的 2015-2019 已于 2026-07-28 回填完成(1219 个交易日,全表 13,962,193 行),并跑严格
数据审计。`moneyflow` / `toplist` 的 2015-2019 仍待按真实策略需求回填:
`pnpm sync:moneyflow|sync:toplist 20150101 20191231`。注意 Tushare 限频,逐年拉可续传。
