...
- ROA 的现有 PIT 字段已接入 FactorBar / 策略引擎，候选虽否决但用户长尾代码仍可研究；应计等需扩
  资产负债/现金流数据的仍不做(守 4.2 需求拉动)。**3.5 以 20 个验证后预置达到原定 20～40 下界
...
| 远期 | 3.7 ML 合成 · 1.3 分红 Model B + 6.5 股息税 · 4.2 数据扩展 · 4.5 多用户工程 | 有前置或等需求拉动；3.3 线性合成已提供 ML 对照基线 |
