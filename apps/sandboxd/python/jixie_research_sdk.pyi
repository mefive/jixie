# Generated by scripts/generators/gen-research-sdk.ts. Do not edit by hand.
...
class _DataApi:
    ...
    # Note: Reading statements does not require FCFF applicability; financial-sector source mappings are not integrated and return an empty frame when no integrated statements exist.
    # Note: fields uses statement_kind.field; the returned field column keeps the unqualified field name. Omitted filters preserve existing calls.
    ...
    def equity_financial_statements(
        ...
        *,
        as_of: str,
        fields: Literal["income.totalRevenue", "income.revenue", "income.operCost", "income.operateProfit", "income.totalProfit", "income.incomeTax", "income.nIncome", "income.nIncomeAttrP", "income.ebit", "income.rdExp", "income.finExpIntExp", "balance_sheet.moneyCap", "balance_sheet.tradAsset", "balance_sheet.notesReceiv", "balance_sheet.accountsReceiv", "balance_sheet.accountsReceivBill", "balance_sheet.othReceiv", "balance_sheet.othRcvTotal", "balance_sheet.inventories", "balance_sheet.prepayment", "balance_sheet.contractAssets", "balance_sheet.othCurAssets", "balance_sheet.totalCurAssets", "balance_sheet.fixAssets", "balance_sheet.fixAssetsTotal", "balance_sheet.cip", "balance_sheet.cipTotal", "balance_sheet.intanAssets", "balance_sheet.goodwill", "balance_sheet.deferTaxAssets", "balance_sheet.othNca", "balance_sheet.totalNca", "balance_sheet.totalAssets", "balance_sheet.notesPayable", "balance_sheet.acctPayable", "balance_sheet.accountsPay", "balance_sheet.advReceipts", "balance_sheet.contractLiab", "balance_sheet.payrollPayable", "balance_sheet.taxesPayable", "balance_sheet.othPayable", "balance_sheet.othPayTotal", "balance_sheet.stBorr", "balance_sheet.nonCurLiabDue1y", "balance_sheet.ltBorr", "balance_sheet.bondPayable", "balance_sheet.othCurLiab", "balance_sheet.totalCurLiab", "balance_sheet.othNcl", "balance_sheet.totalNcl", "balance_sheet.totalLiab", "balance_sheet.minorityInt", "balance_sheet.totalHldrEqyExcMinInt", "balance_sheet.totalShare", "cash_flow.nCashflowAct", "cash_flow.cPayAcqConstFiolta", "cash_flow.nCashflowInvAct", "cash_flow.nCashFlowsFncAct", "cash_flow.cPayDistDpcpIntExp", "cash_flow.nIncrCashCashEqu", "cash_flow.cCashEquBegPeriod", "cash_flow.cCashEquEndPeriod", "cash_flow.netProfit", "cash_flow.deprFaCogaDpba", "cash_flow.amortIntangAssets", "cash_flow.freeCashflow"] | list[Literal["income.totalRevenue", "income.revenue", "income.operCost", "income.operateProfit", "income.totalProfit", "income.incomeTax", "income.nIncome", "income.nIncomeAttrP", "income.ebit", "income.rdExp", "income.finExpIntExp", "balance_sheet.moneyCap", "balance_sheet.tradAsset", "balance_sheet.notesReceiv", "balance_sheet.accountsReceiv", "balance_sheet.accountsReceivBill", "balance_sheet.othReceiv", "balance_sheet.othRcvTotal", "balance_sheet.inventories", "balance_sheet.prepayment", "balance_sheet.contractAssets", "balance_sheet.othCurAssets", "balance_sheet.totalCurAssets", "balance_sheet.fixAssets", "balance_sheet.fixAssetsTotal", "balance_sheet.cip", "balance_sheet.cipTotal", "balance_sheet.intanAssets", "balance_sheet.goodwill", "balance_sheet.deferTaxAssets", "balance_sheet.othNca", "balance_sheet.totalNca", "balance_sheet.totalAssets", "balance_sheet.notesPayable", "balance_sheet.acctPayable", "balance_sheet.accountsPay", "balance_sheet.advReceipts", "balance_sheet.contractLiab", "balance_sheet.payrollPayable", "balance_sheet.taxesPayable", "balance_sheet.othPayable", "balance_sheet.othPayTotal", "balance_sheet.stBorr", "balance_sheet.nonCurLiabDue1y", "balance_sheet.ltBorr", "balance_sheet.bondPayable", "balance_sheet.othCurLiab", "balance_sheet.totalCurLiab", "balance_sheet.othNcl", "balance_sheet.totalNcl", "balance_sheet.totalLiab", "balance_sheet.minorityInt", "balance_sheet.totalHldrEqyExcMinInt", "balance_sheet.totalShare", "cash_flow.nCashflowAct", "cash_flow.cPayAcqConstFiolta", "cash_flow.nCashflowInvAct", "cash_flow.nCashFlowsFncAct", "cash_flow.cPayDistDpcpIntExp", "cash_flow.nIncrCashCashEqu", "cash_flow.cCashEquBegPeriod", "cash_flow.cCashEquEndPeriod", "cash_flow.netProfit", "cash_flow.deprFaCogaDpba", "cash_flow.amortIntangAssets", "cash_flow.freeCashflow"]] | None = None,
    ...
    # Note: At most 100 identifiers, 16 fields, 20 reporting years, and 100000 rows. A user-supplied list is not a historical universe.
    # Note: annual selects December annual reports; quarterly differences YTD flows; ttm reuses the continuous-quarter kernel. Missing values are never zero-filled.
    # Note: Balance-sheet and beginning/ending cash stocks retain their reported observation, without differencing, summing, or averaging; period_basis is point_in_time.
    # Note: Every input must be available by as_of. Reporting-period history at one fixed cutoff is not a historical month-end PIT panel.
    # Note: Preserves status, reasons, formulas, source versions, and availability. Unintegrated financial-sector data is distinct from industrial-model applicability.
    # Example: data.equity_financial_values(["000858.SZ", "600519.SH"], as_of="20260506", fields=["income.revenue", "balance_sheet.totalAssets"], report_start="20230101", report_end="20251231", period="annual")
    # DataFrame columns: as_of_date: datetime64[ns], code: str, industry: str | None, applicability: str, statement_kind: str, field: str, value: float64, unit: str, report_period: datetime64[ns], available_date: datetime64[ns], period_basis: str, status: str, formula: str, formula_version: str, input_versions_json: str, missing_reason: str | None
    def equity_financial_values(
        ...
        *,
        ...
        report_start: str,
        report_end: str,
        period: Literal["reported", "annual", "quarterly", "ttm"] = "reported",
    ) -> pd.DataFrame: ...
