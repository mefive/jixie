...
![Condition input on the Screener page](/docs/images/help/zh/getting-started/first-screen-01-query.png)
...
![Interpreted conditions, result table, and pin button](/docs/images/help/zh/getting-started/first-screen-02-result.png)
