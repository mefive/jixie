...
Jixie helps you observe market conditions, query data, screen stocks, research factors, test trading rules, and review signals produced for the latest trading day. After sign-in, the product opens Market Weather by default. On a first visit, start with the current market, then complete one screen and one backtest.
...
4. [Run your first screen](/help/getting-started/first-screen).
...
- A screen only shows which stocks match the conditions. It does not say they will rise.
