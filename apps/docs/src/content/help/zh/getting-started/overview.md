...
机械交易系用于观察市场状态、用自然语言完成统计研究、研究因子、检验交易规则和查看最新信号。登录后默认进入市场气象页。第一次使用时，可以先了解当前市场，再完成一次自然语言研究和一次回测。
...
| 研究 | 用自然语言研究时间序列关系或时点股票池，查看可核查、可重跑的类型化结果 |
...
4. 按照[第一次完成自然语言研究](/help/getting-started/first-research)得到统计结果或股票池。
