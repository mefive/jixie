...
const sourcePath = new URL('../../src/math/stats.ts', import.meta.url);
const targetPath = new URL('../../src/math/stats-doc.ts', import.meta.url);
...
const banner = `// GENERATED FILE — do not edit. Source of truth: math/stats.ts JSDoc.
