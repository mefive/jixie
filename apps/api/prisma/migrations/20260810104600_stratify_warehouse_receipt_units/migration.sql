...
CREATE TABLE "new_CommodityWarehouseReceipt" (
    ...
    PRIMARY KEY ("productCode", "tradeDate", "unit")
);
INSERT INTO "new_CommodityWarehouseReceipt" ("availableDate", "productCode", "retrievedAt", "sourceName", "sourceRowCount", "sourceUnit", "tradeDate", "unit", "unitCorrectionApplied", "volume", "volumeChange") SELECT "availableDate", "productCode", "retrievedAt", "sourceName", "sourceRowCount", "sourceUnit", "tradeDate", "unit", "unitCorrectionApplied", "volume", "volumeChange" FROM "CommodityWarehouseReceipt";
