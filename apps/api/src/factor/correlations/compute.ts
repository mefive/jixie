...
import { getRebalanceDates, loadSnapshots, type Snap } from '../execution/cross-sectional/data.js';
import { computeFactorSeries, type Series } from '../execution/cross-sectional/series.js';
