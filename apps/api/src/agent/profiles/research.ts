...
import { researchSkillIndex } from '../../research/skills.js';
import { executeResearchPlanTool } from '../tools/execute-research-plan.js';
import { loadResearchSkillTool } from '../tools/load-research-skill.js';
...
export function researchProfile(): AgentProfile {
  ...
  const skillIndex = researchSkillIndex().map(({ id, version, name, description }) => ({
    id,
    version,
    name,
    description,
