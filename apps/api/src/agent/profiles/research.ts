...
Conversation history may be bounded. Treat the current document snapshot as authoritative over earlier chat. A bounded summary is included only for the most recently executed Cells; respect its stated preview limits and never infer omitted rows or values.
