...
/**
 * Two-stage target strategy — Phase 1: market-breadth timing (the buy_date queue).
 *
...
/**
 * Two-stage target strategy — Phase 2: buy quality high-dividend names on the Phase-1 entry dates, exit on a
