...
beforeEach(() => {
  ...
  dependencies.worker.mockImplementation(async (_stage, _runId, items) => ({
...
describe('financial reference history import', () => {
  it('uses market history, bounds batches and skips securities with existing dividends', async () => {
    ...
    expect(dependencies.worker.mock.calls).toEqual([
      ['financial_statements', null, ['20241231', '20250331']],
      ['financial_statements', null, ['20250630']],
      ['financials', null, ['20241231', '20250331']],
      ['financials', null, ['20250630']],
      ['dividends', null, ['000001.SZ']],
      ['dividends', null, ['600001.SH']],
    ]);
