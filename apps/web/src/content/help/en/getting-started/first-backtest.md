...
![Strategy description, send button, and examples in Backtest Lab](/help/zh/getting-started/first-backtest-01-prompt.png)
...
![Dates, capital, base slippage, and Run backtest button](/help/zh/getting-started/first-backtest-02-settings.png)
...
![Backtest metrics, Trades tab, and log area](/help/zh/getting-started/first-backtest-03-metrics.png)
...
![Strategy equity, CSI 300 benchmark, and result tabs](/help/zh/getting-started/first-backtest-04-chart.png)
