...
export const zhFactor = {
  ...
  panel: {
    libraryGroup: '跨资产面板因子',
    methodBadge: '跨资产面板',
    codeReadonly: '内置跨资产面板定义，代码只读',
    codeEditable: '自定义跨资产面板定义，创建后研究协议不可更改',
    assetScopeAudit: '输出：共同月末的跨资产可比分数',
    placeholderQa: '问问这个跨资产因子 —— 如「Rank IC 怎么看」「成本后多空是否可靠」—— 回车发送',
    placeholderAuthor:
      '描述你想横向比较的 ETF 价格信号，如「120 日动量」；或继续对话调整 —— 回车发送',
    chatEmpty:
      '这是一个受控的跨资产面板模板。它在共同月末横向排序 ETF，并报告覆盖率、Rank IC、换手和成本后多空收益。',
    chatEmptyAuthor:
      '这是可编辑的跨资产 Panel Factor Definition V2。首版可使用 ETF 复权收盘价生成跨资产可比分数。',
    paramsSummary: '跨资产 {{assets}} 个 ETF · 月频 · 前瞻 {{horizon}} 日 · {{start}} – {{end}}',
    universe: '固定首发资产池',
    horizon: '持有期',
    ...
    reportNotice:
      '这是跨资产排序证据报告，不是资产配置策略回测；仓位约束、现金管理和调仓执行仍需在策略中验证。',
    researchType: '研究方法',
    target: '预测目标',
    targetValue: '共同月末后未来 {{horizon}} 个交易日总收益',
    periods: '有效月份',
    observations: '有效观测',
    evidenceTitle: '跨资产排序证据',
    ...
    historyParams: '跨资产面板 · {{assets}} 个 ETF · 前瞻 {{horizon}} 日 · {{start}} – {{end}}',
    assetNames: {
      '510300.SH': '沪深 300 ETF',
      '513100.SH': '纳指 ETF',
      '511010.SH': '5年国债 ETF',
