...
export const zhFactor = {
  ...
  release: {
    ...
    timeSeriesHint: '批准不可变报告并冻结时间序列定义；发布版可带入 ETF 策略研究回测',
    timeSeriesMaturityHelp:
      '实验或已验证版可用于策略研究回测；production 门槛完成前不能用于每日信号。',
    useInLab: '带入策略 Lab',
    publishReport: '发布此报告',
    reportRef: '报告 {{id}}',
    codeRef: '代码 {{hash}}',
    finalizeKeyFirst: '请先在编辑器上方确认并锁定策略标识，再发布自定义因子。',
    empty: '尚无发布版本；研究报告不会自动进入策略。',
    publishTitle: '发布不可变因子版本',
    publish: '发布',
    published: '已发布 v{{version}}',
    publishFailed: '发布失败',
    metadataDerived: '输入域、目标资产和输出粒度将由批准报告的冻结定义自动推导。',
    releaseKey: '稳定发布标识',
    releaseKeyPlaceholder: '例如 quality_value',
    maturityLabel: '成熟度',
    maturity: { experimental: '实验', validated: '已验证', production: '生产' },
    lifecycle: { active: '生效中', retired: '已退役' },
    experimentalHelp: '可用于研究和回测引用，不可进入每日生产部署。',
    validatedHelp: '已通过预注册判据和揭示后的正式 Holdout。',
    productionDisabled: '生产（运行门槛尚未开放）',
    duplicate: '这份报告已有相同成熟度的生效版本。',
    inputs: '输入',
    target: '目标',
    domain: {
      price: '价格',
    ...
    output: { asset: '逐资产输出', global: '全局状态输出' },
    approvedBy: '批准报告 {{id}} · {{hash}} · {{date}}',
    retire: '退役',
    retireTitle: '退役 v{{version}}？',
    retireContent: '退役后新策略不能再引用；历史报告和既有引用仍可追溯。',
    retired: 'v{{version}} 已退役',
    retireFailed: '退役失败',
  },
