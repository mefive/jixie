...
export const zhFactor = {
  ...
  researchHandoff: {
    ...
    suggestedReport: '建议评估参数',
    confirmReport: '已从研究范围预填；运行前请确认。其他参数保留 Factor 默认值。',
    range: '{{start}} – {{end}}',
    frequency: { daily: '日频', weekly: '周频', monthly: '月频' },
    minimumListingDays: '上市 ≥ {{days}} 天',
    excludeRiskWarnings: '排除风险警示',
    includeRiskWarnings: '包含风险警示',
    assets: '{{count}} 个标的',
    direction: { positive: '预期正向', negative: '预期负向', unknown: '方向待确认' },
  },
  ...
  timeSeries: {
    ...
    assetNames: {
      ...
      '563360.SH': '中证 A500 ETF',
      '510500.SH': '中证 500 ETF',
      '512100.SH': '中证 1000 ETF',
      '563300.SH': '中证 2000 ETF',
      '159915.SZ': '创业板 ETF',
      '588000.SH': '科创 50 ETF',
      '510880.SH': '上证红利 ETF',
      '159920.SZ': '恒生 ETF',
      '513500.SH': '标普 500 ETF',
      '513100.SH': '纳指 ETF',
      '511010.SH': '国债 ETF',
      '511260.SH': '10年国债 ETF',
      '511090.SH': '30年国债 ETF',
