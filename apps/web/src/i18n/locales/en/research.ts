...
export const enResearch: typeof zhResearch = {
  ...
  dataCatalog: {
    ...
    stockCodes: 'Equity codes (up to 100, comma-separated)',
    financialFields: 'Financial fields (up to 16; empty means all for statements)',
    reportPeriod: 'Reporting-period range',
    financialPeriod: 'Period basis',
    financialTimeHint:
      'Report periods select the financial history; the availability cutoff selects the versions known then. Stock fields retain their reported observation.',
    periodBasis: {
      reported: 'Reported',
      annual: 'Annual',
      quarterly: 'Quarterly',
    ...
    asOfDate: 'Historical availability cutoff',
    frequency: 'Frequency',
    transform: 'Transform',
