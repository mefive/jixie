...
export const enLab: typeof zhLab = {
  ...
  scanTitle: 'Scans and sizing comparison',
  scanStart: 'Start scan',
  scanIntro:
    'Scans override params without rewriting code: up to two dimensions / 25 robustness combinations or five sizing schemes.',
