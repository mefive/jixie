...
export const enLab: typeof zhLab = {
  ...
  scanTitle: 'Parameter robustness scan',
  scanStart: 'Start scan',
  scanIntro:
    'The scan overrides numeric params without rewriting code. It supports up to two dimensions and 25 serial combinations.',
  ...
  scanValuesInvalid: 'Enter at least two finite values for each parameter',
