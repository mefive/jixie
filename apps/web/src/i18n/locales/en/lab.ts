...
export const enLab: typeof zhLab = {
  ...
  backtestHistory: {
    ...
    historical: 'History',
    compare: 'Compare',
    chooseComparison: 'Choose report B',
    exitComparison: 'Exit comparison',
    comparisonLoading: 'Loading comparison report…',
    comparisonTitle: 'Backtest report comparison',
    comparisonDifference: 'Difference is B − A',
    reportA: 'A',
    reportB: 'B',
