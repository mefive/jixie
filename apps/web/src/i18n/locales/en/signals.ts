...
export const enSignals: typeof zhSignals = {
  ...
  pauseFailed: 'Failed to pause deployment',
  pausedHint:
    'New signals are paused. History and accounts remain available; queued jobs may finish.',
  reportSource: 'Backtest report {{id}}',
  legacySource: 'No linked report (legacy deployment)',
